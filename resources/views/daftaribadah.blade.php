...
<div style="  height: auto"; >
    ...
    <div class="bungkus1">
      <h5>REGISTRASI IBADAH RAYA I </h5>
        ...
        <div class="col-lg-6 info-panel4 " >
          <div class="row" >
            <div class="col-lg">
              ...
              <!-- FORM  -->
              <form action="{{ url('/daftaribadah/input') }}" method="post" >
                {{ csrf_field() }}
              ...
              <div class="container">
                <div class="row">
                  <div class="col-sm">
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tgl" value="@foreach($data_daftar as $li){{$li-> hari}}, {{ $li-> tgl }} @endforeach" readonly>
                ...
                <div class="col-sm">
                 <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="waktu" value="@foreach($data_daftar as $li){{ $li-> waktu }}@endforeach" readonly>
                </div>
              </div>
