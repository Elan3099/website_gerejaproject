			...
			<div class="col-sm" >
				...
				<div class="container" style="background-color: #eeeeee; border-radius: 10px; ">
					<div class="imgpadtop2 img-fluid">
						<div class="img " style=" margin-right: 20px;">
							<a href="/check"><img src="foto/document.svg" alt="" height="200px" width="200px" style="display: block; margin: auto;  " > <br> 
								<div class="tulisan4 " >
									<h6>KEHADIRAN IR 1</h6>
								</div>
							</div>
				...
				<div class="col-sm">
					<div class="container" style="background-color: #eeeeee; border-radius: 10px; ">
						<div class="imgpadtop2 img-fluid">
							<div class="img "  style=" margin-right: 20px;">
								<a href="/check2"><img src="foto/input.svg" alt="" height="200px" width="200px" style="display: block; margin: auto;" > <br> 
									<div class="tulisan4"  style="color: white; background-color: #1d3557">
										<h6>KEHADIRAN IR 2</h6></div>
									</div>
								</div>
